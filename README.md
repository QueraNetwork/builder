...
A shell script to build fancy QUNs.

Status and contribution policy
------------------------------

Create-qun is maintained thanks to the contributors who send pull requests.
As of July 2020, (https://github.com/QueraNetwork) is the primary maintainer.
The project home page is <https://github.com/create-qun/create-qun>.

We will merge any pull request that adds something useful and does not break existing things.

If you're an active user and want to be a maintainer, or just want to chat, please ping us on Gitter at [gitter.im/create-qun/Lobby](https://gitter.im/create-qun/Lobby), or [email Andrew directly](floss@apjanke.net).
...
- You can install this script using [Homebrew](https://brew.sh):
  ...
  ```sh
  brew install create-qun
  ```

- You can download the [latest release](https://github.com/create-qun/create-qun/releases/latest) and install it from there:
...
- You can also clone the entire repository and run it locally from there:
  ...
  ```sh
  git clone https://github.com/create-qun/create-qun.git
  ```
...
```sh
create-qun [options ...] <output_name.qun> <source_folder>
```
...
- **--eula \<eula_file\>:** attach a license file to the qun
...
```sh
#!/bin/sh
test -f Application-Installer.qun && rm Application-Installer.qun
create-dqun \
...
If you're running OS X 10.5 or later, you're SOL.
